        ...
        <div class="row-start-1 row-span-1 ">
            ...
            <form class="row-start-2 row-span-6 mt-5 grid grid-rows-8" wire:submit.prevent="create"> 
                <div class="row-span-1 row-start-1">
                    ...
                    <input class="w-full border-0 rounded-lg bg-gray-100" type="text" name="title"wire:model='title' ><span class="text-red-500">@error('title'){{ "Can't be empty." }}@enderror</span>
                </div>
                ...
                <div class="row-span-3 mt-5">
                    ...
                    <textarea style="resize:none" class="w-full rounded-lg border-0 bg-gray-100" rows="5" class="w-full" type="text" name="detail" wire:model='detail'></textarea>
